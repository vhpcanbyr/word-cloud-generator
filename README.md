...
## Notice
This project is a a sample app for a CI/CD practises and most of the activities in this repository have been cloned, readjusted and reconfigured by Vahap Can Bayir.
...
## Git
This project is using git hooks to standardize development on the project. Please run `make git-hooks` to get started.
